...
def _wants_json() -> bool:
    ...
    API routes always receive JSON responses.

    Safe to call even when no Flask request context exists
    (for example, unit tests that directly invoke error handlers).
    """
